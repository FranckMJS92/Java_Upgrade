...
public class GestionNotas {
    ...
    public static void main(String[] args) {
        ...
        double[][] notasProgramacion = { { 4.0, 4.5, 3.8, 4.2, 3.5 }, { 8.0, 7.5, 9.0, 8.3, 8.0 },
                { 7.0, 6.5, 7.5, 6.8, 7.5 } };
                    ...
                    do {
                        ...
                        switch (opcionSecundaria) {
                            case 1:
                                ...
                                System.out.printf("%-20s %-20s %-20s %n", "Andrés Mateo", "Mar Beamud",
                                        "Luis Miguel Richard");
                            ...
                            case 2:
                                System.out.println(
                                        "Indica primero el estudiante del que vas a cambiar la nota. \n 1 para Andrés \n 2 para Mar \n 3 para Richard");
                                ...
                                if (indiceEstudiante < 0 || indiceEstudiante > notasProgramacion.length) {
                                    ...
                                    System.out.println(
                                            "Ahora introduce el índice del examen cuya nota quieras modificar (entre el 1 y el "
                                    ...
                                    if (indiceNota < 0 || indiceNota > notasProgramacion[indiceEstudiante].length) {
                                        ...
                                        System.out.println(
                                                "Dime la nota que quieres poner, utilizando una , para los decimales: ");
                            ...
                            case 3:
                                ...
                                for (int i = 0; i < notasProgramacion.length; i++) {
                                    ...
                                    System.out.println("La nota final del estudiante nº" + (i + 1) + " es: "
                                            + (mediaEntregas * 0.6 + notaExamen * 0.4));
                                }
                                break;
                            case 4:
